import { fetchConnectGrant, resolveTailnetTarget, type GrantOptions } from "@/lib/profiles/tailnetBroker";
import { acquireTailnetSidecar, peekTailnetSidecar, releaseTailnetSidecar } from "@/lib/profiles/tailnetSidecar";
