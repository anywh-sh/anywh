  ...
  shell: {
    ...
    profiles: {
      ...
      add: {
        ...
        description: "Garanta que o agente escolhido está logado na máquina que hospeda o serviço.",
        nameLabel: "nome",
        ...
        creating: "Criando…",
        notLoggedIn: "Não logado. Rode no terminal do host: HOME={path} {agent} login",
        collides: "Esse caminho já pertence ao perfil \"{profile}\" — ele já está no seletor de perfis.",
        confirmed: "Conta confirmada",
        runtimeLabel: "agente",
        copyLabel: "Copiar minhas configurações para este perfil",
        copySummary: "Arquivos: {files} · Servidores MCP: {servers}",
        copyServersNote: "Os servidores MCP vão declarados — o login neles é feito a partir do novo perfil.",
        copyWarnings: "Configurações que citam um caminho que pode não existir aqui: {count}",
