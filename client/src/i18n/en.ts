...
export const en: Dictionary = {
  ...
  chat: {
    ...
    composer: {
      ...
      mode: {
        ...
        "read-only": { label: "Read only", hint: "Reads and plans inside a read-only sandbox; asks before anything that writes" },
  ...
  shell: {
    ...
    profiles: {
      ...
      add: {
        title: "Add profile",
        description: "Make sure the agent you pick is logged in on the machine hosting the service.",
        nameLabel: "name",
        ...
        verifying: "Checking…",
        creating: "Creating…",
        notLoggedIn: "Not logged in. Run this on the host's terminal: HOME={path} {agent} login",
        collides: "That path already belongs to the profile \"{profile}\" — it is already in the profile picker.",
        confirmed: "Account confirmed",
        runtimeLabel: "agent",
        copyLabel: "Copy my configuration to this profile",
        copySummary: "Files: {files} · MCP servers: {servers}",
        copyServersNote: "MCP servers come across declared — you sign in to them from the new profile.",
        copyWarnings: "Settings naming a path that may not exist here: {count}",
        applying: "Applying your configuration…",
        applyFailed: "Profile created, but its configuration wasn't copied: {error}",
      },
      mcpSignIn: {
        title: "Sign in to MCP servers",
        description: "These servers came across declared, not signed in. Start one, open the address it prints wherever you have a browser, then paste the address you land on back here.",
        signIn: "Sign in",
        working: "Waiting…",
        signedIn: "Signed in",
        failed: "Didn't finish",
        pastePlaceholder: "Paste the address you landed on",
        send: "Send",
        done: "Done",
      },
      pair: {
